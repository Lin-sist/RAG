...
C9a 只改离线评测工具，不修改 Java 生成、prompt、citation validator、重答或生产返回。对 unsupported claim 做线上标记/重答仍需独立 Type C change。judge 校准与 objective/judge 全局状态分离属于 C9b，阈值/退出码门禁属于 C10。

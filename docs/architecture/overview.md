...
| `rag-core` | Embedding、向量库、BM25、RRF、rerank、prompt、生成与引用，以及默认关闭的 C16 bounded fact Router | `BoundedQueryRouter`、`FactQueryStrategyExecutor`、`QueryEngineImpl`、`AnswerGeneratorImpl`、`CitationValidator` |
